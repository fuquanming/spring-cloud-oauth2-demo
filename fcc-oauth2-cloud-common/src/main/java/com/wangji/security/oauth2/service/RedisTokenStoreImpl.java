 ...
 */
package com.wangji.security.oauth2.service;
...
/**
 * 集成spring-cloud后 conn.set 不能使用，替换为conn.stringCommands().set
 * @version 
 * @author 傅泉明
 */
public class RedisTokenStoreImpl implements TokenStore {
    ...
    private static final boolean springDataRedis_2_0 = ClassUtils.isPresent(
            ...
            RedisTokenStoreImpl.class.getClassLoader());
    ...
    public RedisTokenStoreImpl(RedisConnectionFactory connectionFactory) {
